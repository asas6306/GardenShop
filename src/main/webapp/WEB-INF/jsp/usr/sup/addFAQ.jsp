...
<script>
addFAQ__submited = false;
function addFAQ__checkAndSubmit(form) {
	if ( addFAQ__submited ) {
		alert('처리중입니다.');
		return;
	}
...
<section class="flex justify-center">
	<div class="max-w-5xl w-full">
		<div class="flex items-center justify-center h-20 text-4xl font-bold">FAQ작성</div>
